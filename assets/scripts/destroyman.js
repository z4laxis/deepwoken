...
function animateTalk() {
  ...
  const talkInterval = setInterval(() => {
    if (isIdle) {
      destroymanDiv.style.backgroundImage = "url('/assets/images/destroyman/speaking.png')";
    } else {
      destroymanDiv.style.backgroundImage = "url('/assets/images/destroyman/idle.png')";
    }
    isIdle = !isIdle;
  }, 500);

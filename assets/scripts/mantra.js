...
function setIcon(attunement, data) {
    ...
    if (data.type === "Attunement") {
        if (data.attribute.includes("Flamecharm")) {
            icon.src = "/assets/images/icons/talent/" + formatIconName(data.name);

        } else if (data.attribute.includes("Frostdraw")) {
            icon.src = "/assets/images/icons/talent/snowflake.png";
            ...
            icon.src = "/assets/images/icons/talent/rift.png";

        } else if (attunement.Ironsing > 0) {
            icon.src = "/assets/images/icons/talent/ironsing.png";

        } else if (attunement.Bloodrend > 0) {
            icon.src = "/assets/images/icons/talent/blood.png";
        }

    } else if (data.type === "Oath") {
        icon.src = "/assets/images/icons/talent/" + formatIconName(data.attribute);

    } else if (data.type === "Attunementless") {
        icon.src = "/assets/images/icons/talent/" + formatIconName(data.name);

    } else if (data.type === "Monster") {
        icon.src = "/assets/images/icons/talent/claw.png";
    
    } 
    
    if (data.name === "Pumpkin Pitch") {
        icon.src = "/assets/images/icons/talent/ball.png";
        
    } else if (data.name === "Soul Beam") {
        icon.src = "/assets/images/icons/talent/orb.png";
    }
}
